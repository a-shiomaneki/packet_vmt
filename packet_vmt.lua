...
vmt_timeoffset_F = ProtoField.new("timeoffset", "vmt.vmt_timeoffset", ftypes.FLOAT)
vmt_x_F = ProtoField.new("x", "vmt.vmt_x", ftypes.FLOAT)
vmt_y_F = ProtoField.new("y", "vmt.vmt_y", ftypes.FLOAT)
vmt_z_F = ProtoField.new("z", "vmt.vmt_z", ftypes.FLOAT)
vmt_qx_F = ProtoField.new("qx", "vmt.vmt_qx", ftypes.FLOAT)
vmt_qy_F = ProtoField.new("qy", "vmt.vmt_qy", ftypes.FLOAT)
vmt_qz_F = ProtoField.new("qz", "vmt.vmt_qz", ftypes.FLOAT)
vmt_qw_F = ProtoField.new("qw", "vmt.vmt_qw", ftypes.FLOAT)
vmt_serial_F = ProtoField.new("serial", "vmt.vmt_serial", ftypes.INT32)
vmt_value_F = ProtoField.new("value", "vmt.vmt_value", ftypes.INT32)
vmt_buttonindex_F = ProtoField.new("buttonindex", "vmt.vmt_buttonindex", ftypes.INT32)
